...
async function main() {
  ...
  if (args.help) {
    process.stdout.write(
      [
        'Usage:',
        '  node scripts/print-barcodes.js --item "Milk" --qty 10',
        '  node scripts/print-barcodes.js --item "Milk" --qty 10 --barcode 123456789012',
        '  node scripts/print-barcodes.js --item "Milk" --qty 10 --printer "EPSON TM-T20III"',
        '  node scripts/print-barcodes.js --item "Milk" --qty 10 --paper 58',
        '',
        'Options:',
